 ...
 * to OSS using the OSS SDK for PHP.
 */
...
$sourceObjectKey = 'my-OSS-object-key-demo';
...
try
{
	 ...
	 */
	$OSSClient -> putObject(['Bucket' => $sourceBucketName,
	...
	$resp = $OSSClient -> getObjectMetadata(['Bucket' => $sourceBucketName, 'Key' => $sourceObjectKey]);
